...
resolve it at startup into an item of VatClasses."""),
    'lino_xl.lib.vat.Plugin.declaration_plugin' : _("""The plugin to use as your national VAT implementation."""),
...
this journal entry."""),
    ...
    'lino_xl.lib.ledger.Voucher.toggle_state' : _("""Toggle between "registered" and "draft" state."""),
...
account. See About returnable VAT."""),
    ...
    'lino_xl.lib.vat.VatAccountInvoice' : _("""Django model for storing  accounting invoices."""),
